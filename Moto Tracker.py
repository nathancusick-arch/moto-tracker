...
st.write(
        ...
        2. Filters should look like "Client" = "Moto Hospitality Limited", "End Date - From" = "01/mm/yyyy" (with date set for whatever month(s) you want to export)
        3. Drop the file in the below box, it should then give you the output file in your downloads
        4. Paste into the Moto Tracker
        5. Done.
        """
)
